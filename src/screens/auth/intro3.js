...
const Intro3 = ({navigation}) => {
  ...
  return (
    <GestureRecognizer onSwipe={onSwipe} style={style.introView}>
      <ScrollView>
        <View>
          <Image source={IMAGE.events_bg} style={style.introBanner} />
        </View>
        <View style={style.body}>
          <View style={{flexDirection:"row"}}>
            <TouchableOpacity onPress={()=>navigation.navigate('Intro2')} style={style.dot}></TouchableOpacity>
            <TouchableOpacity onPress={()=>navigation.navigate('Intro2')} style={style.dot}></TouchableOpacity>
            <View style={style.dotActive}></View>
            <TouchableOpacity onPress={()=>navigation.navigate('Intro4')} style={style.dot}></TouchableOpacity>
          </View>
          <View style={{marginVertical:50, alignItems:"center"}}>
            <Text style={style.heading}>Events</Text>
            <Text style={style.heading2}>You can join clubs of your choice through the app.</Text>
          </View>
